        ...
        resultsEl.innerHTML = `
            <div style="text-align: center; margin-bottom: 30px;">
                ...
                <div style="background: #f8f9fa; padding: 20px; border-radius: 15px; margin-bottom: 25px;">
                    ...
                    <p>
                        هذا البحث جزء من مشروع علمي ضمن برنامج FGS الصيفي، وكان هدفه فهم كيف يتذكر الناس الكلمات حسب ترتيب ظهورها. في هذه التجربة، تم عرض مجموعة من الكلمات لمدة 30 ثانية، ثم طُلب منك أداء مهام تشتيتية بسيطة (مثل مسائل رياضية)، وبعد ذلك طُلب منك تذكر الكلمات التي حفظتها.
                    </p>
                    <p>
                        نحن ندرس ما إذا كان الأشخاص يتذكرون الكلمات التي تظهر في البداية والنهاية بشكل أفضل من الكلمات التي في المنتصف. هذه الظاهرة تُعرف في علم النفس باسم تأثير الموقع التسلسلي، وهي جزء من فهمنا لكيفية عمل الذاكرة قصيرة المدى.
                    </p>
                    <p>
                        كل إجاباتك تظل مجهولة الهوية، ولن تُستخدم إلا لأغراض تعليمية بحتة داخل البرنامج
                    </p>
                    <p>
                        لو عندك أي أسئلة عن الدراسة، يمكنك التواصل مع مشرفي البرنامج على: sondosw360@gmail.com
                    </p>
                </div>
            </div>
        `;
